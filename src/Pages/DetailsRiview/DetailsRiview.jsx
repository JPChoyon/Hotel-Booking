              ...
              <div className="flex flex-wrap -m-2">
                <div className="p-2 w-1/2">
                  <div className="relative">
                    <label className="leading-7  dark:text-black text-sm text-white">
                      Name
                    </label>
                    <input
                      type="text"
                      name="name"
                      placeholder="Name"
                      className="input border-white dark:border-black dark:border-2 h-one input-bordered w-full max-w-xs"
                    />
                  </div>
                </div>
                <div className="p-2 w-1/2">
                  <div className="relative">
                    ...
                    <input
                      ...
                      name="ratting"
                      placeholder="rating"
                      className="input h-one dark:border-black dark:border-2 input-bordered border-white w-full max-w-xs"
                    />
                  </div>
                </div>
                <div className="p-2 w-full ">
                  <div className="relative">
                    ...
                    <input
                      ...
                      name="image"
                      placeholder="photo"
                      className="input h-one dark:border-black dark:border-2 input-bordered border-white w-full "
                    />
                  </div>
                </div>
                <div className="p-2 h-one w-full">
                  <div className="relative">
                    <label className="leading-7  dark:text-black text-sm h-one text-white">
                      Message
                    </label>
                ...
                <div className="p-2 w-full">
                  <button
                    type="submit"
                    className="flex btn btn-three mx-auto text-white bg-transparent border-2 dark:text-black rounded text-lg"
                  >
                    Add Review
                  </button>
                </div>
